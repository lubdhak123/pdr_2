        ...
        <section className="py-24 bg-surface border-t border-outline-variant/10" id="problem-statement">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-32">
              ...
              <div className="lg:col-span-5 space-y-10">
                ...
                <div className="p-6 rounded-md bg-surface-container-high/50 border-l-4 border-tertiary">
                  <p className="text-sm font-semibold text-on-surface italic font-body">
              ...
              <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-surface-container-lowest p-8 rounded-lg shadow-sm border border-outline-variant/10 flex flex-col justify-between">
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-on-surface-variant mb-6 font-label">Gap Paradox Analysis</p>
                  ...
                  <p className="mt-8 text-xs text-on-surface-variant leading-tight font-body">The unmet gap now rivals 80% of the total formal supply volume.</p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative h-32 flex items-end justify-between px-2">
                      ...
                      <div className="z-10 text-center">
                        ...
                        <span className="block text-[10px] text-slate-500 font-bold">DEC 23</span>
                      </div>
                      <div className="z-10 text-center">
                        <span className="block text-2xl font-black text-tertiary-fixed">17%</span>
                        <span className="block text-[10px] text-slate-500 font-bold">DEC 24</span>
                      </div>
                    </div>
                  </div>
                  <div className="mt-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-6 text-on-surface-variant/60 text-sm font-medium font-body">Join PDR in re-architecting the ledger of trust.</p>
            </div>
          </div>
        </section>
